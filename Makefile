...
postgres-integration:
	...
	@REVGUARD_TEST_POSTGRES_DSN="$(REVGUARD_TEST_POSTGRES_DSN)" \
		$(VENV_PYTHON) -m unittest tests.test_postgres_store_integration tests.test_money_recovery_postgres tests.test_migrations_postgres tests.test_runtime_safety_postgres tests.test_recording_consistency_postgres tests.test_approval_consistency_postgres tests.test_workflow_concurrency_postgres tests.test_recovery_consistency_postgres tests.test_coordinator_consistency_postgres -v
