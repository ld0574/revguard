...
- 0.5.6 已完成案件快照/Matrix 进度的版本检查、StageTask 原子领取与结果审计、旧 attempt 拒绝和安全元数据合并。267 项测试、91% 显示覆盖率与隔离浏览器通过，生产演示数据不变，见 [workflow-concurrency-20260912](evidence/workflow-concurrency-20260912/README.md)。继续复核已经领取任务的旧 Worker 在恢复后的工具调用隔离，以及续签、任务取消和排队的一致性。
