"""Run the approval contracts against unique PostgreSQL databases."""
...
from tests import test_approval_consistency as contracts


@unittest.skipUnless(os.getenv("REVGUARD_TEST_POSTGRES_DSN"), "requires disposable PostgreSQL server")
class TestPostgresApprovalConsistency(contracts.TestApprovalConsistency):
    def setUp(self):
        import psycopg
        ...
        database = "revguard_approval_" + uuid.uuid4().hex
