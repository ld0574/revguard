"""Recovery contracts against unique PostgreSQL databases."""
...
from tests import test_recovery_consistency as contracts


@unittest.skipUnless(os.getenv("REVGUARD_TEST_POSTGRES_DSN"), "requires disposable PostgreSQL server")
class TestPostgresRecoveryConsistency(contracts.TestRecoveryConsistency):
    def setUp(self):
        import psycopg
        ...
        database = "revguard_recovery_" + uuid.uuid4().hex
